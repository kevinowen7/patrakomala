...
class _WorkshopDetailState extends State<WorkshopDetail> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: SafeArea(
        child: BlocBuilder<BisnisBloc, BisnisState>(builder: (_, bisnisState) {
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            image:
                                AssetImage('assets/images/skeleton_image.gif'),
                            fit: BoxFit.cover,
                          )),
                      child: Container(
                        width: double.infinity,
                      ...
                      child: CustomTabBar(
                        ...
                        onTap: (index) {
                          if (index == 1) {
                            context
                                .bloc<ProductBloc>()
                                .add(ProductBisnis(bisnis.value.bisnisId));
                          }
                          setState(() {
                            selectedIndex = index;
                          });
